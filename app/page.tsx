export default function Portfolio() {
  return (
    <div className="h-full flex">
      {/* Left Panel - About */}
      <div className="flex-1 bg-zinc-50 text-black flex flex-col justify-start items-center p-8 relative">
        <div className="text-center space-y-4">
          <h1 className="text-3xl font-light tracking-wide">About me</h1>
          <div className="text-lg font-bold">Hanzhang Yin</div>
      ...
      <div className="flex-1 bg-zinc-200 text-zinc-600 flex flex-col justify-start items-center p-8 relative">
        <div className="text-center space-y-4">
          <h2 className="text-3xl font-light tracking-wide">Research</h2>
          <div className="text-lg font-bold">Algebraic Combinatorics & Representation Theory</div>
      ...
      <div className="flex-1 bg-zinc-400 text-zinc-200 flex flex-col justify-start items-center p-8 relative">
        <div className="text-center space-y-4">
          <h2 className="text-3xl font-light tracking-wide">Teaching</h2>
          <div className="mt-8 space-y-4 text-left">
            <div>
              <div className="text-lg font-bold">MATH 127: Calculus III (Lab)</div>
              <div className="text-sm font-light">Fall 2025</div>
              <div className="text-sm font-light">University of Kansas, Lawrence, KS, USA</div>
            </div>
            <div>
              <div className="text-lg font-bold">MATH 115: Business Calculus</div>
              <div className="text-sm font-light">Spring 2025</div>
              <div className="text-sm font-light">University of Kansas, Lawrence, KS, USA</div>
            </div>
            <div>
              <div className="text-lg font-bold">MATH 104: Precalculus Mathematics</div>
              <div className="text-sm font-light">Fall 2024</div>
              <div className="text-sm font-light">University of Kansas, Lawrence, KS, USA</div>
            </div>
            <div>
              <div className="text-lg font-bold">MATH 125: Calculus I</div>
            ...
            <div>
              <div className="text-lg font-bold">MATH 002: Intermediate Mathematics</div>
      ...
      {/* Right Panel - Contact */}
      <div className="flex-1 bg-zinc-600 text-white flex flex-col justify-start items-center p-8 relative">
        <div className="text-center space-y-4">
          <h2 className="text-3xl font-light tracking-wide">Contact</h2>
